...
This file provides guidance to AI coding agents when working with this repository. The canonical version of this guidance lives in `CLAUDE.md` — keep both files in sync.
